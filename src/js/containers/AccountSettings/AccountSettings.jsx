  ...
  renderFirstNameField(field){
    ...
    return(
      ...
      <label htmlFor="formGroupExampleInput">First Name</label>
        <input {...field.input} type="text"  className="form-control" placeholder="First name" />
  ...
  renderLastNameField(field){
    ...
    return(
      ...
      <label htmlFor="formGroupExampleInput">Last Name</label>
        <input {...field.input} type="text"  className="form-control" placeholder="Last Name" />
        <div className='text-danger mb-2'>
        {field.meta.touched ? field.meta.error: ''}
        </div>
      </div>
  ...
  renderPhoneField(field){
    ...
    return(
      ...
      <label htmlFor="formGroupExampleInput">Phone</label>
        <input {...field.input} type="text"  className="form-control" placeholder="phone" />
        <div className='text-danger mb-2'>
        {field.meta.touched ? field.meta.error: ''}
        </div>
      </div>
  ...
  renderUserInformationField(field){
    ...
    return(
      ...
      <label htmlFor="formGroupExampleInput">User Information</label>
        <input {...field.input} type="text"  className="form-control" placeholder="User Information" />
        <div className='text-danger mb-2'>
        {field.meta.touched ? field.meta.error: ''}
        </div>
      </div>
  ...
  renderWebsiteField(field){
    ...
    return(
      ...
      <label htmlFor="formGroupExampleInput">Website</label>
        <input {...field.input} type="text"  className="form-control" placeholder="Website" />
        <div className='text-danger mb-2'>
        {field.meta.touched ? field.meta.error: ''}
        </div>
      </div>
              ...
              <div className="card">
                ...
                <div className="container">
                  <form onSubmit={handleSubmit(this.onSubmit)}> 
                    ...
                    <Field name='info' component={this.renderUserInformationField} />
        ...
        <div className="col-md-10">
          <div className="card">
            ...
            <div className="container">
              ...
              <li className="list-group-item">Company Name: {userInformation.company}</li>
                <li className="list-group-item">Client Name: {userInformation.firstName} {userInformation.lastName}</li>
                <li className="list-group-item"> Email: {userInformation.email} </li>
